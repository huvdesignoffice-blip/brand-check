  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            <a href="/admin" className="border-b-2 border-blue-600 text-blue-600 px-3 py-4 text-sm font-medium">
              Dashboard
            </a>
            <a href="/admin/brand-check" className="border-b-2 border-transparent text-gray-600 hover:text-gray-900 px-3 py-4 text-sm font-medium">
              Brand Check
            </a>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-2">
              ...
              >
                View Brand Check Results
              </a>
              <button
                disabled
                className="block w-full text-left px-4 py-3 bg-gray-100 text-gray-400 rounded-lg cursor-not-allowed"
              >
                Generate New Report (Coming soon)
              </button>
              <button
                disabled
                className="block w-full text-left px-4 py-3 bg-gray-100 text-gray-400 rounded-lg cursor-not-allowed"
        ...
        {/* Recent Brand Assessments */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Recent Brand Assessments</h2>
            <a href="/admin/brand-check" className="text-sm text-blue-600 hover:text-blue-700">
              View all
            </a>
          </div>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                {results.slice(0, 10).map((result) => {
                  const scores = [
                    result.q1_market_understanding, result.q2_competitive_analysis, result.q3_self_analysis,
                    result.q4_value_proposition, result.q5_uniqueness, result.q6_product_service,
                    result.q7_communication, result.q8_inner_branding, result.q9_kpi_management,
                    result.q10_results, result.q11_ip_protection, result.q12_growth_intent
                  ];
